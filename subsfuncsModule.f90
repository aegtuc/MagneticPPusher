...
!**************************************************************************************************************
!
!                                          F U N C T I O N:  calculoRadioGiro
!                                          
!**************************************************************************************************************
function calculoRadioGiro(mass, energyJoule, q, B)
!energyJoule
implicit none
real(8), intent(in) :: mass, energyJoule, q, B
real(8) :: calculoRadioGiro
real(8) :: lorFac, v
v = velocityFromEnergy(mass=mass, energy=energyJoule)
lorFac = lorentzFactor(v=v)
calculoRadioGiro =  (mass*lorFac)*v/(q*B)
return
end function calculoRadioGiro
!**************************************************************************************************************
!
...
call writeOutputFile(pp=pp,time=time,r=r,BFld=BFldOnPath)
return
...
!
!**************************************************************************************************************
subroutine writeOutputFile(pp,time,r,BFld)
implicit none
...
open(1,file=trim(pp%outputFileName))
